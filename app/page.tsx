...
const basePath = '/company-name-1776672730616';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'Product 1 is a cutting-edge solution designed to provide unparalleled performance and efficiency. With its advanced features and user-friendly interface, it is an ideal choice for customers looking for a reliable and high-quality product.', i: 'https://images.pexels.com/photos/7038233/pexels-photo-7038233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Product 2', d: 'Product 2 is a versatile and innovative offering that caters to a wide range of customer needs. Its unique features and benefits make it an excellent option for those seeking a product that is both functional and affordable.', i: 'https://images.pexels.com/photos/373939/pexels-photo-373939.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Product 3', d: 'Product 3 is a premium offering that boasts exceptional quality and craftsmanship. With its advanced technology and sleek design, it is perfect for customers who demand the best and are willing to invest in a top-notch product.', i: 'https://images.pexels.com/photos/28712136/pexels-photo-28712136.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Product 4', d: 'Product 4 is a specialized solution designed to meet the specific needs of our customers. Its unique features and benefits make it an excellent choice for those seeking a product that is both tailored to their requirements and affordable.', i: 'https://images.pexels.com/photos/24554111/pexels-photo-24554111.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Product 5', d: 'Product 5 is a groundbreaking offering that combines innovation and quality to provide an unparalleled customer experience. With its advanced features and user-friendly interface, it is an ideal choice for customers looking for a product that is both high-quality and easy to use.', i: 'https://images.pexels.com/photos/21547019/pexels-photo-21547019.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">Company Name</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/31259204/pexels-photo-31259204.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Best Website <span className="text-accent">Excellence.</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Company Name delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/60123456789`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Company Name, we specialize in delivering top-notch products that exceed our customers\' expectations. With a strong focus on innovation and customer satisfaction, we strive to be the go-to destination for high-quality products. Our team is dedicated to providing exceptional service and support to ensure a seamless experience for our clients.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to revolutionize the industry by providing affordable, high-quality products that make a positive impact on our customers\' lives.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to deliver exceptional products and services that meet the evolving needs of our customers, while maintaining a commitment to affordability and quality.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Affordable</h4>
                  <p className="text-sm text-on-surface-variant">At Company Name, we believe in being affordable, which is why we strive to offer competitive pricing without compromising on the quality of our products.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">High-Quality</h4>
                  <p className="text-sm text-on-surface-variant">We are dedicated to delivering high-quality products that meet the highest standards of excellence, ensuring that our customers receive the best possible solutions for their needs.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/21582448/pexels-photo-21582448.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">company@gmail.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Company Name</div>
            <p className="text-white/60 text-sm leading-relaxed">Best Website</p>
          </div>
